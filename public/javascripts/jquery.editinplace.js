    ...
    return this.each(function(){
        ...
        .click(function(){
            ...
            if(!editing)
            {
                ...
                {
                    var use_field_type = '<textarea name="inplace_value" class="ui-widget-content" rows="' + settings.textarea_rows + '" cols="' + settings.textarea_cols + '">' + jQuery(this).text().trim().escape_html() + '</textarea>';
                }
                else if(settings.field_type == "text")
                {
                    var use_field_type = '<input type="text" name="inplace_value" class="ui-widget-content" value="' +
                    jQuery(this).text().trim().escape_html() + '" maxlength="'+settings.maxlength+'" />';
                }
                else if(settings.field_type == "select")
                {
                    var optionsArray = settings.select_options.split(',');
                    //var use_field_type = '<select name="inplace_value" class="ui-widget-content"><option value="">' + settings.select_text + '</option>';
                    var use_field_type = '<select name="inplace_value" class="ui-widget-content">';
                ...
                $(".inplace_save,.inplace_cancel").button();
            }/* END- if(!editing) -END */
